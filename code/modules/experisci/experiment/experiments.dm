...
/datum/experiment/scanning/random/plants/wild
	...
	performance_hint = "\"Wild\" mutations (upon harvest) have been recorded to occur above 30 points of instability, while species mutations occur above 60 points of instability."
	total_requirement = 1
