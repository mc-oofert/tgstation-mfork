...
/datum/map_generator/cave_generator/teststation
	weighted_open_turf_types = list(/turf/open/misc/asteroid/basalt/teststation = 1)
	weighted_closed_turf_types = list(/turf/closed/mineral/random/volcanic/teststation = 1)
