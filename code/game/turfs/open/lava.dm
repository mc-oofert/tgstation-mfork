...
/turf/open/lava/proc/is_safe()
	...
	var/static/list/lava_safeties_typecache = typecacheof(list(/obj/structure/lattice/catwalk, /obj/structure/stone_tile, /obj/structure/lattice/lava,/obj/structure/industrial_lift,/obj/structure/industrial_lift/debug,/obj/structure/industrial_lift/public,/obj/structure/industrial_lift/tram))
